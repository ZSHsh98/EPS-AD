...
parser.add_argument("--id", type=int, default=8, help="number of experiment")
...
if 1:
	...
	# cifar
	path = f"/mnt/cephfs/ec/home/zhangshuhai/score_diffusion_t_cifar_wrn_70_16/scores_cleansingle_vector_norm20perb_image10000/"
...
def test(epoch, diffusion_t, dataset):
	...
	attack_methods=['PGD']#,'MIM', 'TIM', 'DI_MIM','BIM_L2', 'MM_Attack']
	# attack_method = 'PGD'
	...
	for num_sub in [50]:
		...
		for epsilon in [0.01569]: #0.00392, 0.00784, 0.01176, 0.01569, 0.01961, 0.02353, 0.02745, 0.03137]:
			...
			for attack_method in attack_methods:
				...
				t=20
				for cof_loss_EPS in  [0.000001, 0.0000001]:#[ 0.0, 1, 0.1, 0.01, 0.001, 0.0001, 0.00001]:
					...
					if dataset == 'imagenet':
						...
						path_cln = f'/mnt/cephfs/home/zhangshuhai/DiffPure/score_cifar_t_ablation/scores_clean200perb_image.npy'
						path_adv = f'/mnt/cephfs/dataset/zhangshuhai/ICML2022_diffusion_detection/ceph/score_diffusion_t_cifar_white_attack/scores_adv_{attack_method}_{epsilon}_5single_vector_norm{t}{isperb_image}{data_size}{cof_loss_EPS}.npy'
...
# cifar
# CUDA_VISIBLE_DEVICES=6 python train_D_extractor_2_white_attack.py --epochs 200 --lr 0.00002 --id 8 --sigma0 15 --sigma 100  --epsilon 2 --feature_dim 300 --dataset cifar
# imagenet
# CUDA_VISIBLE_DEVICES=7 python train_D_extractor_2_white_attack.py --epochs 200 --lr 0.002 --id 6 --sigma0 0.5 --sigma 100  --epsilon 10 --feature_dim 300 --dataset imagenet